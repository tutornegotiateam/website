...
class Personas_externas_admin extends CI_Controller {
	...
	{  
        ...
        $this->load->model('personas_externas_model', 'dm');      
...

	{
		...
		if (!$this->session->userdata('id')) {
			...
			$this->load->view('personas_externas_admin/index', $data);
            ...
            echo $id2= $this->input->post('PersonaUsu');
               ...
               // echo $update;
                ...
                if($update){
                    ...
                    redirect('personas_externas_admin');
