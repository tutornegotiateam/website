...
class Contacto_admin extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('Contacto_model', 'dm');
	...
	public function index()
	{
		if (!$this->session->userdata('id')) {
			...
			$data = array(
			'title' => 'Centro de Mensajes de Contacto',
			...
			$this->load->view('contacto_admin/index', $data);
