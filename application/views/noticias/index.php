					...
					<div class="card-block">
						...
						<div class="col-md-12 search-panel">
							...
							<div class="float-right">
								<a href="<?php echo site_url('noticias_admin/agregar/'); ?>" class="btn btn-linkedin">
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<?php
								if (!empty($registros_datos)) {

									foreach ($registros_datos as $row) {
								...
								<tr>
									...
									<td>
										...
										<a href="<?php echo site_url('noticias_admin/editar/'.$row['id'].'/'.$row['idioma']); ?>" class="btn btn-twitter btn-xs" data-backdrop="static">
											<i class="fa fa-pencil" title="Editar usuario">
											</i>
										</a>

										<a href="<?php echo site_url('noticias_admin/borrar/'.$row['id']); ?>" class="btn btn-google-plus btn-xs" onclick="return confirm('Esta seguro que desea borrar el contenido?')" title="Borrar usuario">
