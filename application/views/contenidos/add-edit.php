            ...
            <form method="post" name="form-1" id="form-1">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                     ...
                     <select name="seccion" id="seccion" class="form-control">
                        	...
                        	<option value="<?php echo $r3['seccion_id']; ?>" <?php if(@$member->seccion==$r3['seccion_id']){ ?>selected="selected" <?php } ?> ><?php echo $r3['seccion']; ?></option>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Titulo" value="<?php echo !empty(@$member->titulo)?@$member->titulo:''; ?>" <?php if($title==''){ ?> onkeyup="if (isArrowKey(event)) return ;urlAmigable(this.value,<?php echo $idioma_ ?>);" <?php } ?>>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <label>Color Fondo Titulo y Subtitulo</label></br>
...
*/ ?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <label>Banner de la página </label>

                        <input  id="banner_bg" name="banner_bg" type="text" class="form-control" value="<?php echo !empty(@$member->banner_bg)?@$member->banner_bg:''; ?>" >

	  <a href="javascript:open_popup('<?php echo base_url(); ?>assets/libs/filemanager/dialog.php?type=2&popup=1&field_id=banner_bg&Yave=12345')" class="btn btn-success" >Seleccionar Imagen</a>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" name="contenido" id="contenido" placeholder="Contenido"><?php echo !empty(@$member->contenido)?@$member->contenido:''; ?></textarea>
                 ...
                 <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <label>Se puede vizualizar</label>

<div class="form-check">

  <input class="form-check-input" type="checkbox" value="1" id="f_contacto" name="f_contacto" <?php if(@$member->f_contacto){ echo  'checked="checked"'; } ?>>
...
<div class="form-check">
  ...
  <input class="form-check-input" type="checkbox" value="1" id="f_cotizacion" name="f_cotizacion" <?php if(@$member->f_cotizacion){ echo  'checked="checked"'; } ?>>
...
<div class="form-check">
  ...
  <input class="form-check-input" type="checkbox" value="1" id="f_temas_similares" name="f_temas_similares" <?php if(@$member->f_temas_similares){ echo  'checked="checked"'; } ?>>

  <label class="form-check-label" for="defaultCheck2">

    Temas similares al contenido</label>

</div>

<div class="form-check">

  <input class="form-check-input" type="checkbox" value="1" id="f_twitter" name="f_twitter" <?php if(@$member->f_twitter){ echo  'checked="checked"'; } ?>>
...
<div class="form-check">
  ...
  <input class="form-check-input" type="checkbox" value="1" id="f_facebook" name="f_facebook" <?php if(@$member->f_facebook){ echo  'checked="checked"'; } ?>>
   ...
   <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="activo" class="form-control">
                        	...
                        	<option value="1" <?php if(@$member->activo==1){ echo 'selected="selected"'; } ?>  >Activo</option>

                        	<option value="0" <?php if(@$member->activo==0){ echo 'selected="selected"'; } ?> >Inactivo</option>
	  ...
	  <a href="javascript:open_popup('<?php echo base_url(); ?>assets/libs/filemanager/dialog.php?type=2&popup=1&field_id=fieldID1&Yave=12345')" class="btn btn-success" >Seleccionar Documento</a>
                     ...
                     <div class="col-md-4 mb-3">
                        ...
                        <a href="#"  class="btn btn-success" class="form-control" data-toggle="modal" data-target="#miModal">Agregar responsables</a>
                    ...
                    <tr id="id-<?php echo  $r4->PersonaId; ?>">

                    	<td><a href='javascript:void(0);' class='btn btn-danger btn-xs' onclick='removeRow(<?php echo $r4->PersonaId; ?>)'><i class='fa fa-times' aria-hidden='true'></i></a></td>

                    	<td><?php echo  $r4->PersonaId; ?></td>
                ...
                <a href="<?php echo site_url('contenidos_admin'); ?>" class="btn btn-secondary">Regresar</a>
                ...
                <?php 
                	...
                	<tr>
                		...
                		<td>
                			...
                			<a href="javascript:void(0);" class="btn btn-success btn-xs" onclick="addRow('<?php echo $r2['PersonaId']; ?>','<?php echo $nombre; ?>')"><i class="fa fa-plus" aria-hidden="true"></i></a>
