<table class="display table" cellspacing="0" width="100%" id="table-participantes">
    <thead>
    <tr>
        <th>Empleado</th>
        <th>Tipo Empleado</th>
    ...
    <?php if(!empty($arr_responsable_proyecto)){ foreach($arr_responsable_proyecto as $r2){ ?>
        <tr class="tr_participante" data-id="<?php echo $r2['PersonaId']; ?>" data-name="<?php echo $r2['PersonaNom'].' '.$r2['PersonaApePat'].' '.$r2['PersonaApeMat']; ?>">
