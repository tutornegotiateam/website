<script type= 'text/javascript'>
		$(document).ready(function () {
			$('#product-grid').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": "<?php echo base_url(); ?>/contacto_admin/get_registros"
			});
			...
			$(document).delegate('.delete', 'click', function() { 
				if (confirm('Usted desea borrar el registro?')) {
					...
					$.ajax({
						type: "POST",
						url: "<?php echo base_url(); ?>/contacto_admin/delete_registro",
						data: 'id=' + id,
						cache: false,
						success: function() {
			...
			$(document).delegate('#save', 'click', function() {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>/contacto_admin/update_registro",
			...
			$(document).delegate('#addNew', 'click', function(event) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>/contacto_admin/add_registro",
					data: str,
					cache: false,
					success: function() {
...
$(document).ready(function(){
	...
	$(document).delegate('#btn-visto', 'click', function() {	
	    ...
	    let id = $('#id').val();
	     $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>/contacto_admin/opc_visto",
			data: 'id=' + id,
			cache: false,
	...
	$(document).delegate('#btn-novisto', 'click', function() {	
	    ...
	    let id = $('#id').val();
	     $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>/contacto_admin/opc_novisto",
			data: 'id=' + id,
			cache: false,
			success: function(data) {
				if(data==1){
	...
	$(document).delegate('.edit', 'click', function() {	
	    ...
	    $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>/contacto_admin/ver_registro",
			data: 'id=' + id,
			cache: false,
			success: function(data) {
