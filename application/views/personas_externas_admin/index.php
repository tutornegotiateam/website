<script type= 'text/javascript'>
		$(document).ready(function () {
			$('#product-grid').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": "<?php echo base_url(); ?>/personas_externas_admin/get_registros"
			});
			...
			$(document).delegate('.delete', 'click', function() { 
				if (confirm('Usted desea borrar el registro?')) {
					...
					$.ajax({
						type: "POST",
						url: "<?php echo base_url(); ?>/personas_externas_admin/delete_registro",
						data: 'id=' + id,
						cache: false,
						success: function() {
			...
			$(document).delegate('#save', 'click', function() {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>/personas_externas_admin/update_registro",
			...
			$(document).delegate('#addNew', 'click', function(event) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>/personas_externas_admin/add_registro",
					data: str,
					cache: false,
					success: function() {
...
$(document).ready(function(){
	...
	$(document).delegate('.edit', 'click', function() {	
	    ...
	    $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>/personas_externas_admin/ver_registro", 
			data: 'id=' + id,
			cache: false,
...
$("#registros").validate({
			...
			submitHandler: function(form) {
				...
				setTimeout(function() {
	             ...
	             $.ajax({
			        type: "POST",
			        url: "<?php echo base_url();?>personas_externas_admin/editar/",
