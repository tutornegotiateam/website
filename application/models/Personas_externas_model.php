<?php
class  Personas_externas_model extends CI_Model{
	...
	function get_records() {		
		...
		//total records
		$sqlCount = 'SELECT COUNT(' . $indexColumn . ') AS row_count FROM ' . $this->contactos .' WHERE PersonaTipo=2';
        ...
        if($where==''){
			$where.=' WHERE PersonaTipo=2';
		}else{
			$where.=' AND PersonaTipo=2';
		}
		//final records
