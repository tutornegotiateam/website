    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logoinner.attr('src', '/assets/site/img/logos/logo-inner.png');
                logodefault.attr('src', '/assets/site/img/logo_tutornegotia2.png');
                logowhite.attr('src', '/assets/site/img/logos/logo-white.png');
                logowhitedark.attr('src', '/assets/site/img/logos/logo-white.png');
                logo2.attr('src', '/assets/site/img/logos/logo-2-light.png');
                logo4.attr('src', '/assets/site/img/logos/logo-4.png');
                logo5.attr('src', '/assets/site/img/logos/logo-5-light.png');
                logo6.attr('src', '/assets/site/img/logos/logo-6.png');
                logo7.attr('src', '/assets/site/img/logos/logo-7.png');
                logo8.attr('src', '/assets/site/img/logos/logo-8.png');
            } 
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                logoinner.attr('src', '/assets/site/img/logo_tutornegotia2.png');
                logodefault.attr('src', '/assets/site/img/logo_tutornegotia2.png');
                logowhite.attr('src', '/assets/site/img/logos/logo-white.png');
                logowhitedark.attr('src', '/assets/site/img/logos/logo-dark.png');
                logo2.attr('src', '/assets/site/img/logos/logo-2-dark.png');
                logo4.attr('src', '/assets/site/img/logos/logo-4.png');
                logo5.attr('src', '/assets/site/img/logos/logo-5-dark.png');
                logo6.attr('src', '/assets/site/img/logos/logo-6.png');
                logo7.attr('src', '/assets/site/img/logos/logo-7.png');
                logo8.attr('src', '/assets/site/img/logos/logo-8.png');
            }
